...
CREATE TABLE IF NOT EXISTS TarefasProjeto (
    ...
    disciplina_projeto VARCHAR(50) NOT NULL CHECK (disciplina_projeto IN ('Arquitetura', 'Estrutura', 'Complementares', 'Obras')),
...
('b4b1a8d0-1c32-4e89-9a21-000000000004', 'Modelagem 3D', 'Arquitetura', 'Eduardo Marques', '01-08-2026', 30),
('b4b1a8d0-1c32-4e89-9a21-000000000005', 'Renderização 3D (Imagens Finais)', 'Arquitetura', 'Eduardo Marques', '15-08-2026', 0),
